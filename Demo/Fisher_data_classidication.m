...
% show performance
    ...
    if(aa==2)
    figure
    scatter3(X_a_reduced{aa}(1:50,1),X_a_reduced{aa}(1:50,2),X_a_reduced{aa}(1:50,3),'*','LineWidth',2);
    hold on;
    scatter3(X_a_reduced{aa}(51:100,1),X_a_reduced{aa}(51:100,2),X_a_reduced{aa}(51:100,3),'o','LineWidth',2);
    hold on;
    scatter3(X_a_reduced{aa}(101:150,1),X_a_reduced{aa}(101:150,2),X_a_reduced{aa}(101:150,3),'x','LineWidth',2);
    grid on
    ...
    if(aa==1)
    figure
    scatter(X_a_reduced{aa}(1:50,1),X_a_reduced{aa}(1:50,2),'*','LineWidth',2);
    hold on;
    scatter(X_a_reduced{aa}(51:100,1),X_a_reduced{aa}(51:100,2),'o','LineWidth',2);
    hold on;
    scatter(X_a_reduced{aa}(101:150,1),X_a_reduced{aa}(101:150,2),'x','LineWidth',2);
    grid on
